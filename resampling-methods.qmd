...
- **Bootstrap**
  - Estimates the ***uncertainty*** associated with a given value or statistical learning method. Example, it can estimate the `standard errors` of the coeﬃcients from a linear regression ﬁt
